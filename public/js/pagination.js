$(document).ready(function() {
	$('#dataTable').dataTable({
		...
		"oLanguage": {
			"sLengthMenu": "Viendo _MENU_ productos por pagina",
			"sZeroRecords": "No se han encontrado resultados para tu búsqueda ",
			"sInfo": "Viendo _START_ a _END_ de _TOTAL_ productos",
			"sInfoEmpty": "Mostrando 0 a 0 de 0 productos",
			"sInfoFiltered": "(Filtrado desde _MAX_ productos totales)",
			"sSearch": "Buscar",
			"oPaginate": {
				"sLast": "Ultimo",
				"sFirst": "Primero",
