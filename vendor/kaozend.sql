...
INSERT INTO `banks` VALUES (2,'Bancolombia','');
...
INSERT INTO `brands` VALUES (1,'Toshiba','','',''),(2,'Acer','','','');
...
--
-- Table structure for table `log_authenticate`
--

DROP TABLE IF EXISTS `log_authenticate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `log_authenticate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `log_authenticate`
--

LOCK TABLES `log_authenticate` WRITE;
/*!40000 ALTER TABLE `log_authenticate` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_authenticate` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `master_categories` VALUES (2,'Portatiles','','');
...
CREATE TABLE `modules_roles` (
  ...
  KEY `fk_table1_modulos_idx` (`module`),
  KEY `fk_table1_roles1_idx` (`rol`),
  CONSTRAINT `fk_table1_modulos` FOREIGN KEY (`module`) REFERENCES `modules` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `notes` VALUES (5,1,'clasificacion','campo descripcion revisar tipo de dato'),(7,1,'login','revisar ataques xss en campos de usuario y contraseña'),(8,1,'tabla de logs login','crear tabla de log por accesos y problemas comunes'),(9,1,'revisar listados de control de acceso ACL','adfafd');
...
INSERT INTO `payments_methods` VALUES (1,'Contado','',0),(2,'Credito','',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='password encriptado con md5\nfechas timestamp';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'Andres','Colonia','admin','andreskal2@gmail.com',NULL,NULL,1,'$2y$10$GvjgLjiDLdG4qLpeBXjdJehvOJEIRBiI4ZEHorm9ewxu0FmQggIae','$2y$10$GvjgLjiDLdG4qLpeBXjdJehvOJEIRBiI4ZEHorm9ewxu0FmQggIae',0);
...
-- Dump completed on 2014-09-03 15:53:42
