...
return array(
	'action' => array(
		...
		'delete_yes' 	=> '<input type="submit" name="del" value="Si" class="btn btn-danger btn-sm"/>',
		'delete_no' 	=> '<input type="submit" name="del" value="No" class="btn btn-default btn-sm"/>',
		'return' 		=> '<label class="btn btn-default btn-sm">Regresar</label>',
		'login' 		=> 'Ingresar',
		'icons' => array(
