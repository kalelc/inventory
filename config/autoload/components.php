...
return array(
	'component' => array(
		...
		'admin' 						=> array('administración','administración'),
		...
		'client'						=> array('clientes','cliente'),
		'company' 						=> array('compañias','compañia'),
		'content' 						=> array('contenidos','contenido'),
		'cost' 							=> array('costos','costo'),
		'customer' 						=> array('clientes','cliente'),
		'description' 					=> array('descripciones','descripción'),
		'details_receive_inventory'		=> array('detalles entradas','detalle entrada','file_path'=> 'public/files/details_receive_inventory'),
		'details_output_inventory'		=> array('detalles salidas','detalle salida'),
		...
		'process' 						=> array('procesos','proceso'),
		...
		'rol' 							=> array('roles','rol'),
		'sale_value'					=> array('valor ventas','valor venta'),
		'security' 						=> array('seguridad','seguridad'),
		...
		'specification_measures' 		=> array('especificaciones medidas','especificación medida'),
		'status' 						=> array('estados','estado'),
		'seller' 						=> array('vendedores','vendedor'),
